  ...
  return (
    <Layout>
      ...
      <div className="min-h-screen h-full w-full relative flex flex-col items-center ">
          ...
          <div className="max-w-7xl w-full h-full px-4 md:px-10 ">
            <div className="w-full flex justify-center">
              <blockquote className="relative mb-5  w-full">
                <svg className="absolute top-0 left-5 md:left-1/4 transform -translate-x-10 -translate-y-8 h-16 w-16 text-gray-100 dark:text-gray-700" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        ...
        <section id="residence" className="w-full h-full flex justify-center  relative md:mt-96">'
        ...
        <section className=" md:-translate-y-14 max-w-7xl w-full h-full flex flex-col items-center justify-center text-center mt-5 ">
          ...
          <button className="text-sm px-4 py-2 border border-[#0A3255] hover:bg-[#0A3255] hover:text-white">Contact us</button>
        </section>
