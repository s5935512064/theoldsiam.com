            ...
            <div className="min-h-screen h-full w-full relative flex flex-col items-center ">
                ...
                <section id="shop" className="relative  w-full h-full flex flex-col items-center py-10 mt-10">
                    <div className="max-w-7xl w-full h-full ">
                        <div className="w-full flex justify-center">
                            ...
                            <blockquote className="relative mb-5  w-full ">
                                ...
                                <div className="relative z-10">
                                    ...
                                    <h1 className="text-[#0A3255] text-7xl font-semibold mb-3">
                                        SHOPPING CENTER

                                    </h1>

                                    <p className="font-light pr-10 mb-5">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ut, quibusdam. Dolorum rerum consequuntur corrupti voluptatibus expedita non, quibusdam natus iusto culpa cum quasi architecto consequatur maiores ipsum minus voluptatum ducimus!</p>

                                    <button className="font-light px-4 py-2 border">Discover More</button>
                        ...
                        <div className="w-full h-[450px] bg-black relative my-5">
                            <Image
                ...
                <section id="residence" className="w-full h-full flex justify-center  relative ">'
                    <div className="w-full h-[725px] relative bg-[url('/assets/home/LOUNG1.jpg')] bg-fixed bg-no-repeat bg-cover">
                        {/* <Image
                    ...
                    <div className="max-w-7xl w-full h-[725px]  absolute flex justify-center items-center">
                        <div className="bg-white/90 w-fit h-fit flex justify-center p-10 md:p-20 items-center backdrop-blur rounded-tr-3xl rounded-bl-3xl">
                            <div className="text-center">
                                ...
                                <h1 className="text-5xl font-bold text-[#0A3255] mb-4">THE OLD SIAM <br />RESIDENCE</h1>
                                <p className="text-slate-800 max-w-md mb-4 font-light">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quas voluptate rem nostrum voluptatem, libero ab fugit sapiente aut omnis ullam illo delectus totam magni beatae</p>
                ...
                <section id="story" className="relative mt-10  w-full max-w-7xl h-[500px] ">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2">
                        <div className="grid items-center">
                            <blockquote className="relative ">
                                ...
                                <div className="relative z-10">
                                    ...
                                    <h1 className="text-[#0A3255] text-7xl font-semibold">
                                        THE OLD SIAM
                                        <span className="text-7xl font-Allison font-light text-gray-400 -ml-6">plaza</span>
                                    </h1>

                                    <p className="font-light pr-10 mb-6">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ut, quibusdam. Dolorum rerum consequuntur corrupti voluptatibus expedita non, quibusdam natus iusto culpa cum quasi architecto consequatur maiores ipsum minus voluptatum ducimus!</p>

                                    <button className="font-light px-4 py-2 border">Read More</button>
                        ...
                        <div className="w-[450px] h-[450px] relative translate-x-16 hover:scale-110 duration-500 delay-150 rounded-full overflow-hidden">
                ...
                <section className="max-w-7xl w-full h-full ">
                    <div className="py-4 w-full flex -translate-y-32">
                ...
                <section className=" -translate-y-14 max-w-7xl w-full h-full flex flex-col items-center justify-center ">
