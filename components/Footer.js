...
const Footer = () => {
    return (
        <>
            <div className="py-2 w-full h-full  mt-10 flex flex-col justify-center items-center bg-[#0A3255] text-white">
                <div className="px-4 md:px-10 max-w-7xl w-full h-full flex flex-col lg:flex-row lg:justify-between items-center">

                    <div className=" w-full  py-2  flex flex-col lg:flex-row gap-3  h-full justify-center items-center text-white">
                        <div className="flex  flex-col lg:flex-row justify-start items-center w-full  ">
                            <p className=" text-sm font-light  py-1 md:mr-3">
                        ...
                        <div className="w-full flex  divide-x divide-white justify-center lg:justify-start gap-3 lg:border-l border-white   ">

                            <p className=" text-sm font-light cursor-pointer pl-3  ">
                                Disclaimer
                            </p>
                            <p className=" text-sm font-light pl-3 cursor-pointer ">
                                Privacy Policy
                            </p>
                        </div>
                    </div>

                    <div className="w-full lg:w-1/2 border-t border-white py-2 h-full items-center lg:border-0 ">
                        <p className="text-white text-sm font-light text-center lg:text-right">
