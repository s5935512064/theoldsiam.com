const Footer = () => {
    return (
        <>
            <div className="py-5 w-full h-28  mt-10 flex flex-col justify-center items-center bg-[#0A3255] text-white">
                <div className="max-w-7xl h-full w-full flex justify-between items-center py-3 ">


                    <div className="flex h-full items-center  ">
                        <p className=" font-light ">More way to follow</p>
                        <div className="flex items-center gap-1  ml-2">
                            ...
                            <a
                                href="mailto:sales@siamsindhorn.com"
                                target="_blank"
                ...
                <div className="max-w-7xl h-full w-full flex  items-center border-t py-2 ">
                    <p className=" font-light ">Copyright © 2022 , Siam Sindhorn Co.,Ltd All Rights Reserved.
                    </p>
